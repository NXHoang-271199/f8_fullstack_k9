...
import { TableContainer, Table, Paper, TableHead, TableRow, TableCell, TableBody, Typography } from "@mui/material";
import EditIcon from '@mui/icons-material/Edit';
import DeleteOutlineIcon from '@mui/icons-material/DeleteOutline';
import '../../index.css'
import style from './style.module.css'

const FCommonTable = ({ columns, rows, title, maxWidth, onUpdate, onDelete }) => {
    return (
        <>
            <Typography
